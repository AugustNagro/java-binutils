...
public class Coff implements Closeable {
  ...
  /**
   * Returns the line number information for the given section. The section should represent a
   * ".text" or other code section.
   * 
   * @return an array of line number information, or an empty array if no such information is
   *         present.
   */
  ...
  /**
   * Returns the relocation information for the given section. The section should represent a
   * ".text" or other code section.
   * 
   * @return an array of relocation information, or an empty array if no such information is
   *         present.
   */
  ...
  /**
   * Returns the actual section data (= executable code + initialized data) for the given section
   * header.
   * 
   * @return a byte buffer from which the data can be read, never <code>null</code>.
   */
